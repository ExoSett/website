...
The combined print PDF contains the front as page 1 and the back as page 2. Text is converted to vector paths during PDF export for reliable commercial output. The SVG masters retain editable IBM Plex Sans text and reference the repository's local WOFF2 font files.
